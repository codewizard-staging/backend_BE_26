...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM be_030.FundingRound");
    jdbcTemplate.execute("DELETE FROM be_030.Stage");
    jdbcTemplate.execute("DELETE FROM be_030.Document");
    jdbcTemplate.execute("DELETE FROM be_030.Investor");
    jdbcTemplate.execute("DELETE FROM be_030.Founder");
    jdbcTemplate.execute("DELETE FROM be_030.Startup");
     jdbcTemplate.execute("DELETE FROM be_030.StartupFounders");
     jdbcTemplate.execute("DELETE FROM be_030.StartupKeyMetrics");
     jdbcTemplate.execute("DELETE FROM be_030.InvestorInvestmentPreferences");
     jdbcTemplate.execute("DELETE FROM be_030.StartupPreviousRounds");
     jdbcTemplate.execute("DELETE FROM be_030.FundingRoundInvestors");
